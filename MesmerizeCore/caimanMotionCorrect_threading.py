...
in a separate processes from the main desktop application. I intend to also use this as
part of the headless version of Mesmerize so that motion correction
(which is computationally intensive) can be done on a cluster
