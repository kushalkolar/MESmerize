...
class Ui_CrossCorrelationControls(object):
    def setupUi(self, CrossCorrelationControls):
        ...
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(CrossCorrelationControls)
        ...
        self.verticalLayoutLeftMain.addWidget(self.label_5)
        ...
        self.horizontalLayout_2.addWidget(self.doubleSpinBoxLagThreshold)
        ...
        self.horizontalLayout_2.addWidget(self.checkBoxAbsoluteValue)
        ...
        self.horizontalLayout_3.addWidget(self.doubleSpinBoxMaximaThreshold)
    ...
    def retranslateUi(self, CrossCorrelationControls):
        ...
        self.label_2.setText(_translate("CrossCorrelationControls", "Visualize in heatmap:"))
        ...
        self.label_3.setText(_translate("CrossCorrelationControls", "lag threshold (seconds)"))
        self.checkBoxAbsoluteValue.setText(_translate("CrossCorrelationControls", "absolute value"))
        self.label_4.setText(_translate("CrossCorrelationControls", "maxima threshold"))
