...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        DockWidget.setTabOrder(self.lineEditAin, self.doubleSpinBoxMinCorr)
        ...
        DockWidget.setTabOrder(self.doubleSpinBoxDecayTime, self.spinBoxRf)
        ...
        DockWidget.setTabOrder(self.spinBoxK, self.comboBoxDeconv)
        DockWidget.setTabOrder(self.comboBoxDeconv, self.lineEdName)
