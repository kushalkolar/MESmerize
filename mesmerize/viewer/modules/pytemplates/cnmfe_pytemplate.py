...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        self.doubleSpinBoxMinPNR.setMaximum(100.0)
        self.doubleSpinBoxMinPNR.setSingleStep(0.25)
        ...
        self.doubleSpinBoxMinSNR.setSingleStep(0.5)
        ...
        DockWidget.setTabOrder(self.plainTextEdit_eval_kwargs, self.checkBoxKeepMemmap)
...
"Use single quotes for strings, do not use double quotes"))
        self.groupBox_eval_kwargs.setTitle(_translate("DockWidget", "Use e&valuation param kwargs"))
