...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        self.lineEditNameRigid = QtWidgets.QLineEdit(self.dockWidgetContents)
        self.lineEditNameRigid.setObjectName("lineEditNameRigid")
        self.horizontalLayout_15.addWidget(self.lineEditNameRigid)
        self.btnAddToBatchRigid = QtWidgets.QPushButton(self.dockWidgetContents)
        self.btnAddToBatchRigid.setObjectName("btnAddToBatchRigid")
        self.horizontalLayout_15.addWidget(self.btnAddToBatchRigid)
        ...
        DockWidget.setTabOrder(self.lineEditNameRigid, self.btnAddToBatchRigid)
        DockWidget.setTabOrder(self.btnAddToBatchRigid, self.spinboxMaxDev)
...
"Use single quotes for strings, do not use double quotes."))
        ...
        self.label_20.setText(_translate("DockWidget", "If do only rigid correction add here"))
        self.lineEditNameRigid.setPlaceholderText(_translate("DockWidget", "Enter name"))
        self.btnAddToBatchRigid.setText(_translate("DockWidget", "Add to batch"))
