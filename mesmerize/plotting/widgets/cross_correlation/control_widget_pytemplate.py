...
class Ui_CrossCorrelationControls(object):
    def setupUi(self, CrossCorrelationControls):
        ...
        self.verticalLayoutLeftMain = QtWidgets.QVBoxLayout(self.widget)
        ...
        self.comboBoxDataColumn = QtWidgets.QComboBox(self.widget)
        ...
        self.comboBoxLabelsColumn = QtWidgets.QComboBox(self.widget)
        ...
        self.comboBoxPreNormalize = QtWidgets.QComboBox(self.widget)
        ...
        self.radioButtonLag = QtWidgets.QRadioButton(self.widget)
        ...
        self.radioButtonMaxima = QtWidgets.QRadioButton(self.widget)
        ...
        self.checkBoxAbsoluteValue = QtWidgets.QCheckBox(self.widget)
        ...
        self.doubleSpinBoxLagThreshold = QtWidgets.QDoubleSpinBox(self.widget)
        ...
        self.doubleSpinBoxMaximaThreshold = QtWidgets.QDoubleSpinBox(self.widget)
        ...
        self.pushButtonComputeAllData = QtWidgets.QPushButton(self.widget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButtonExportAllData = QtWidgets.QPushButton(self.widget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lineEditCurve1UUID = QtWidgets.QLineEdit(self.widget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.graphicsViewCurve1 = PlotWidget(self.widget)
        ...
        self.lineEditCurve2UUID = QtWidgets.QLineEdit(self.widget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.graphicsViewCurve2 = PlotWidget(self.widget)
        ...
        self.listWidgetSampleID = QtWidgets.QListWidget(self.layoutWidget)
