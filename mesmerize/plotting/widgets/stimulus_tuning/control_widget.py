...
class Ui_ControlsDock(object):
    ...
    def retranslateUi(self, ControlsDock):
        ...
        self.comboBox_method.setItemText(0, _translate("ControlsDock", "mean"))
        self.comboBox_method.setItemText(1, _translate("ControlsDock", "max"))
        self.comboBox_method.setItemText(2, _translate("ControlsDock", "median"))
        self.comboBox_method.setItemText(3, _translate("ControlsDock", "min"))
