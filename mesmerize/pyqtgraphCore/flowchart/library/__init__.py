...
from . import Data, Display, Filters, Math, Definitions, Statistics, Clustering, Hierarchical, Neighbors, Transform, Metrics
for mod in [Data, Display, Filters, Math, Definitions, Statistics, Clustering, Hierarchical, Neighbors, Transform, Metrics]:
