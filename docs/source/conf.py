...
htmlhelp_basename = 'Mesmerizedoc'
...
latex_documents = [
    (master_doc, 'Mesmerize.tex', 'Mesmerize Documentation',
     'Kushal Kolar', 'manual'),
]
...
man_pages = [
    (master_doc, 'mesmerize', 'Mesmerize Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Mesmerize', 'Mesmerize Documentation',
     author, 'Mesmerize', 'One line description of project.',
     'Miscellaneous'),
]
