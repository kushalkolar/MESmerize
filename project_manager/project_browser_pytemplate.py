...
class Ui_Form(object):
    def setupUi(self, Form, df, exclude, special):
        ...
        Form.resize(931, 775)
        # self.BtnJupyter = QtWidgets.QPushButton(self.layoutWidget)
        ...
        # self.BtnConsole = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.BtnCopyFilters = QtWidgets.QPushButton(Form)
        ...
        self.BtnCopyFilters.setGeometry(QtCore.QRect(10, 20, 80, 26))

        # self.horizontalLayout_3.addWidget(self.BtnCopyFilters)


        self.BtnResetFilters = QtWidgets.QPushButton(Form)
        self.BtnResetFilters.setEnabled(False)
        self.BtnResetFilters.setObjectName("BtnResetFilters")
        self.BtnResetFilters.setGeometry(QtCore.QRect(100, 20, 80, 26))
        ...
        # self.BtnOpenCaAnlysis.setObjectName("Open Analyzer")
        # self.horizontalLayout_3.addWidget(self.BtnOpenCaAnlysis)
        ...
        for col in df.columns:
            if col not in exclude:
                ...
                self.widget[colNum].setGeometry(QtCore.QRect((10 + (colNum % 8) * 231), ypos, 225, 321))
